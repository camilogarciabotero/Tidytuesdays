...
```{r country-comparison, fig.align= "center", fig.height= 20, fig.width=13, dpi = 100, warning=FALSE, message=FALSE, fig.cap= "Fig 1. Comparison of the different coffee ratings for the different cups across countries and its associate distribution coffee cups showing whcich countries have the best set of coffes accorting to total rating"}
